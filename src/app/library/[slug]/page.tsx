...
const libraryData = {
  ...
  africa: {
    ...
    openingHours: " Monday-Friday 8:00am - 4:00pm",
    contact: {
      phone: "+234 8123 300 989",
      email: "instituteofafricanstudieslibra@gmil.com",
      librarian: "Mrs. Omolola O. Adedokun",
      librarianImage: "/facultylibrarians/africa/africa.jpg",
    },
    services: [
      "Access to Information Resources: Physical Collections and Electronic Resources",
  ...
  technology: {
    ...
    openingHours: " Monday-Friday 8:00am - 4:00pm",
    contact: {
      phone: "+234 8033 909 053",
      email: "d.otulugbu@gmail..com",
      librarian: "Dr. Dumebi Otulugbu",
      librarianImage: "/facultylibrarians/Technology/tech.jpeg",
    },
    services: [
      "Charging and Discharging",
      "Shelving and Shelve reading",
      "Clearance Services to staff and students",
      "Statistics of users and books",
      "Library Orientation to Faculty new students",
      "Stamping new accessions with ownership stamp",
      "Creating standardized records for dissertations and long essays",
      "Creating a database for Faculty Library holdings",
