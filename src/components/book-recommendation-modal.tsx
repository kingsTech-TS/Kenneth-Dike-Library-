...
export default function BookRecommendationModal({ isOpen, onClose }: BookRecommendationModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Add the new recommendation to Firestore
      await addDoc(collection(db, "bookRecomendation"), {
        name: formData.name,
      ...
      setIsSubmitted(true)
      toast.success("Book recommendation submitted successfully!")
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        required
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 cursor-pointer text-sm"
                      >
